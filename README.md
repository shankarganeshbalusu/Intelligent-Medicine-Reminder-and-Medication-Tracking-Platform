...
### Prerequisites
Make sure you have Node.js (v16+) and Python (v3.9+) installed on your computer.

### Step 1: Running the Backend API
1. Open your terminal and navigate to the backend folder:
   ```bash
   cd "C:\Users\MY PC\Documents\Intelligent-Medicine-Reminder-and-Medication-Tracking-Platform\backend"
   ```
...
3. Start the Uvicorn web server:
   ...
   ```
4. The backend is now running at `http://127.0.0.1:8000/`. You can view the automatically generated interactive documentation at `http://127.0.0.1:8000/docs` to test endpoints manually.

### Step 2: Running the Frontend Client
1. Open a new terminal window or tab and navigate to the frontend folder:
   ```bash
   cd "C:\Users\MY PC\Documents\Intelligent-Medicine-Reminder-and-Medication-Tracking-Platform\frontend"
   ```
