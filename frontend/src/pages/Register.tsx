...
import { Pill, Mail, Lock, User, Loader2, AlertCircle, CheckCircle2, Eye, EyeOff } from 'lucide-react';
      ...
      <div className="md:col-span-7 w-full">
        ...
        <div className="glass-card rounded-3xl p-8 relative overflow-hidden bg-slate-900/90 border border-cyan-500/30 backdrop-blur-2xl shadow-[0_0_30px_rgba(6,182,212,0.15)] text-white">
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-slate-300 font-semibold mt-1">Get started with PillSync today</p>
          </div>
          ...
          {success && (
            <div className="mb-6 p-4 bg-green-500/20 border border-green-500/40 rounded-xl flex items-start gap-3 text-green-300 text-sm font-bold shadow-sm">
              ...
              <span>Account created successfully! A verification link has been sent to your email inbox ({email}). Please click the link to verify your account before logging in. Redirecting...</span>
            </div>
          )}

          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-xs font-black text-cyan-300 uppercase tracking-wider mb-1.5">
                Full Name
              </label>
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-2.5 rounded-xl border border-cyan-500/30 bg-slate-900 text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-cyan-500/30 focus:border-cyan-400 transition-all font-semibold shadow-inner"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-12 py-2.5 rounded-xl border border-cyan-500/30 bg-slate-900 text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-cyan-500/30 focus:border-cyan-400 transition-all font-semibold shadow-inner"
                  placeholder="••••••••"
                />
                <button
                  type="button"
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <button
                  ...
                  className={`py-3 px-4 rounded-xl border font-black text-xs transition-all ${
                    role === 'patient'
            ...
            <button
              ...
              className="w-full flex items-center justify-center py-3 bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-white font-black rounded-xl shadow-[0_0_20px_rgba(6,182,212,0.4)] transition-all cursor-pointer disabled:opacity-50 disabled:pointer-events-none mt-2"
            >
              {loading ? (
          ...
          <div className="text-center mt-6">
            <p className="text-sm text-slate-300 font-semibold">
              ...
              <Link to="/login" className="text-cyan-400 font-extrabold hover:text-cyan-300 hover:underline">
                Log in
              </Link>
            </p>
          </div>
